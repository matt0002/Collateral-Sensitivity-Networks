...
def diff_eq(final_graphs, drug1, drug2, drug3, drug_4, mutant_growth=0.25, susceptible_growth=0.21, death_rate=0.29,
            cycle_time=3):
    ...
    figure = set_up_ODE(drugs_final, df_, columns, mutant_growth, susceptible_growth, death_rate, cycle_time)
    return figure
...
def set_up_ODE(drugs_final, df, all_drugs, mutant_growth, susceptible_growth, death_rate, cycle_time):
    # select drugs
    ...
    print(growth_array)
    graph_ode = ODE_for_Switching_systems(growth_array, carrying_capacity, states, drugs_considered,
                                          state_associations, death_rate, cycle_time)
